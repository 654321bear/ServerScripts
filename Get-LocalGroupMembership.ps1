<#
        ...
        .Example
            ./Get-LocalGroupMembership.ps1 -ComputerName srvmem1, srvmem2
 
            Queries the local administrators group membership and writes the details to c:\temp\localGroupMembers.CSV
 
        .Example
            ./Get-LocalGroupMembership.ps1 -ComputerName (get-content c:\temp\servers.txt)
...
Param(
	...
	[Parameter()]
    [string]
    $OutputFileName = "DallasServersAdministrators.csv"
)
